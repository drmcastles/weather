...
public class Main {
    ...
    private static final String apiKey = "b5eed699-c094-41ea-b9d5-1fab59194402";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            double avgTemp = avgTemperature(jsonResponse, limit);
            String text = String.format("Средняя температура за %d дней: %f °C", limit, avgTemp);
    ...
    private static double avgTemperature(JSONObject jsonResponse, int limit) {
